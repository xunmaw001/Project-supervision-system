        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="教师" onclick="checkRole('jiaoshi')">&nbsp;教师
                        </label>
                    </div>
                </div>
				...
				<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--publicSubColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/xuesheng/register.jsp'">注册  学生</button></div>
				<%--<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--publicSubColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/jiaoshi/register.jsp'">注册  教师</button></div>--%>

...
<body style="background-image:url('/xiangmujianduxitong/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input id="jiaoshiPhone" name="jiaoshiPhone" class="form-control"
                                           onchange="jiaoshiPhoneChickValue(this)"  placeholder="教师手机号">
                                </div>
                                   <div class="form-group col-md-12">
                                       <label>性别</label>
        ...
        function validform() {
            return $("#register").validate({
                ...
                messages: {
                        ...
                        jiaoshiPhone: "教师手机号不能为空",
                        jiaoshiPhoto: "教师头像不能为空",
                        sexTypes: "性别不能为空",
                        jiaoshiEmail: "电子邮箱不能为空",
                }
            }).form();
        }

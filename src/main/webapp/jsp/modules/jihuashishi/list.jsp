...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">项目计划实施管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">项目计划实施列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">项目计划实施列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="jihuashishiNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="计划实施名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        计划实施类型
                                        <div class="layui-input-inline">
                                            <select name="jihuashishiTypesSelectSearch"  style="width: 150px;" id="jihuashishiTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //计划实施名称
            var jihuashishiNameSearchInput = $('#jihuashishiNameSearch');
            if( jihuashishiNameSearchInput != null){
                if (jihuashishiNameSearchInput.val() != null && jihuashishiNameSearchInput.val() != '') {
                    searchForm.jihuashishiName = $('#jihuashishiNameSearch').val();
                }
            }
     
                //计划实施类型
            var jihuashishiTypesSelectSearchInput = document.getElementById("jihuashishiTypesSelectSearch");
            if(jihuashishiTypesSelectSearchInput != null){
                var jihuashishiTypesIndex = jihuashishiTypesSelectSearchInput.selectedIndex;
                if( jihuashishiTypesIndex  != 0){
                    searchForm.jihuashishiTypes= document.getElementById("jihuashishiTypesSelectSearch").options[jihuashishiTypesIndex].value;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("jihuashishi/page", "GET", {
                ...
                jihuashishiDelete: 1,
                //本表的
                jihuashishiName: searchForm.jihuashishiName,
                jihuashishiTypes: searchForm.jihuashishiTypes,
            //级联表的
...
/*
            ...
            //计划实施名称
            var jihuashishiNameCell = document.createElement('td');
            jihuashishiNameCell.innerHTML = item.jihuashishiName;
            row.appendChild(jihuashishiNameCell);


            //计划实施类型
            var jihuashishiTypesCell = document.createElement('td');
            jihuashishiTypesCell.innerHTML = item.jihuashishiValue;
            row.appendChild(jihuashishiTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jihuashishi/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjihuashishi", "addjihuashishi");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function jihuashishiTypesSelectSearch() {
            var jihuashishiTypesSelectSearch = document.getElementById('jihuashishiTypesSelectSearch');
            if(jihuashishiTypesSelectSearch != null) {
                jihuashishiTypesSelectSearch.add(new Option('-请选择-',''));
                if (jihuashishiTypesOptions != null && jihuashishiTypesOptions.length > 0){
                    for (var i = 0; i < jihuashishiTypesOptions.length; i++) {
                            jihuashishiTypesSelectSearch.add(new Option(jihuashishiTypesOptions[i].indexName,jihuashishiTypesOptions[i].codeIndex));
                    }
                }
            }
        }

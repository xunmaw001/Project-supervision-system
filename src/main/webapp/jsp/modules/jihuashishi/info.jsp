            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">项目计划实施登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="xiangmuId" name="xiangmuId" v-model="ruleForm.xiangmuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jihuashishiName" name="jihuashishiName" class="form-control"
                                               v-model="ruleForm.jihuashishiName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>计划实施类型</label>
                                    <input style="width: 450px" id="jihuashishiValue" name="jihuashishiValue" class="form-control"
                                           v-model="ruleForm.jihuashishiValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jihuashishi/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.jihuashishiContent != null && ruleForm.jihuashishiContent != 'null' && ruleForm.jihuashishiContent != '') {
            var jihuashishiContentUeditor = UE.getEditor('jihuashishiContentEditor');
                jihuashishiContentUeditor.ready(function () {
                    ...
                    jihuashishiContentUeditor.setDisabled('fullscreen');
            });
        }
    }

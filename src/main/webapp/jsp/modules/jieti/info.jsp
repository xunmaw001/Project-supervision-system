            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">项目结题登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>学生</label>
                                            <input style="width: 450px" id="xueshengId" name="xueshengId" class="form-control"
                                                   v-model="ruleForm.xueshengId" readonly>
                                        </div>


                                        <div class="form-group col-md-6">
                                            <label>老师</label>
                                            <input style="width: 450px" id="jiaoshiId" name="jiaoshiId" class="form-control"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="xiangmuUuidNumber" name="xiangmuUuidNumber" class="form-control"
                                                   v-model="ruleForm.xiangmuUuidNumber" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="xiangmuJingfei" name="xiangmuJingfei" class="form-control"
                                                   v-model="ruleForm.xiangmuJingfei" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xiangmuYesnoValue" name="xiangmuYesnoValue" class="form-control"
                                               v-model="ruleForm.xiangmuYesnoValue" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                         <label>审核意见</label>
                                        <sapn html="xiangmuYesnoText"></sapn>
                                    </div>
                            <!-- 本表所有字段 -->
                                ...
                                <input id="xiangmuId" name="xiangmuId" v-model="ruleForm.xiangmuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>结题时间</label>
                                        <input style="width: 450px" id="jeitiTime" name="jeitiTime" class="form-control"
                                               v-model="ruleForm.jeitiTime" readonly>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yaojiaoJingfei" name="yaojiaoJingfei" class="form-control"
                                               v-model="ruleForm.yaojiaoJingfei" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>是否已缴</label>
                                    <input style="width: 450px" id="jietiValue" name="jietiValue" class="form-control"
                                           v-model="ruleForm.jietiValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.jietiContent != null && ruleForm.jietiContent != 'null' && ruleForm.jietiContent != '') {
            var jietiContentUeditor = UE.getEditor('jietiContentEditor');
                jietiContentUeditor.ready(function () {
                    ...
                    jietiContentUeditor.setDisabled('fullscreen');
            });
        }
    }

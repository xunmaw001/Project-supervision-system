...
<%--
        ...
        //缴费
        function jiaofei(id,yaojiaoJingfei) {
            $("#jiaofeiId").val(id);
            $("#jiaofeiYaojiaoJingfei").val(yaojiaoJingfei);
            $("#shijiJiaofeiYaojiaoJingfei").val(0.0);
            $('#jiaofeiModel').modal('show');
        }
--%>

            <div class="modal fade" id="jiaofeiModel" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <input type="hidden" id="jiaofeiId">
                                要缴费金额:
                                <div class="col-sm-9">
                                    <input type="number" id="jiaofeiYaojiaoJingfei" readonly style="width: 140px;" class="form-control form-control-sm">
                                </div>
                            ...
                            <div class="row">
                                缴费金额:
                                <div class="col-sm-9">
                                    <input type="number" id="shijiJiaofeiYaojiaoJingfei" style="width: 140px;" class="form-control form-control-sm"
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" id="receive" onclick="jiaofeiShenhe()" class="btn btn-primary">缴费</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">项目结题管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">项目结题列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">项目结题列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="jietiTypesSelectSearch"  style="width: 150px;" id="jietiTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(xiangmuYesnoTypesSelectSearchInput != null){
                ...
                //是否已缴
            var jietiTypesSelectSearchInput = document.getElementById("jietiTypesSelectSearch");
            if(jietiTypesSelectSearchInput != null){
                var jietiTypesIndex = jietiTypesSelectSearchInput.selectedIndex;
                if( jietiTypesIndex  != 0){
                    searchForm.jietiTypes= document.getElementById("jietiTypesSelectSearch").options[jietiTypesIndex].value;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("jieti/page", "GET", {
                ...
                jietiDelete: 1,
                //本表的
                jietiTypes: searchForm.jietiTypes,
            //级联表的
...
/*
            ...
            //结题时间
            var jeitiTimeCell = document.createElement('td');
            jeitiTimeCell.innerHTML = item.jeitiTime;
            row.appendChild(jeitiTimeCell);


            //要交经费
            var yaojiaoJingfeiCell = document.createElement('td');
            yaojiaoJingfeiCell.innerHTML = item.yaojiaoJingfei;
            row.appendChild(yaojiaoJingfeiCell);


            //是否已缴
            var jietiTypesCell = document.createElement('td');
            jietiTypesCell.innerHTML = item.jietiValue;
            row.appendChild(jietiTypesCell);
            ...
            if(window.sessionStorage.getItem("role") == '学生' && item.jietiTypes == 1){
                
                var editBtn = document.createElement('button');
                var editAttr = 'jiaofei(' + item.id +','+item.yaojiaoJingfei + ')';
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jieti/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        function jiaofeiShenhe() {
            var mymessage = confirm("确定要缴费么？");
            if (mymessage == true) {
                let shijiJiaofeiYaojiaoJingfei = $("#shijiJiaofeiYaojiaoJingfei").val();
                if(Number(shijiJiaofeiYaojiaoJingfei) != Number($("#jiaofeiYaojiaoJingfei").val())){
                    alert("要缴费金额不是所需金额");
                    return false;
                }
                let data={
                ...
                httpJson("jieti/update", "POST", data, (res) => {
                    if(res.code == 0){
                        alert('缴费成功');
                        getDataList();
                    }else{
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjieti", "addjieti");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function jietiTypesSelectSearch() {
            var jietiTypesSelectSearch = document.getElementById('jietiTypesSelectSearch');
            if(jietiTypesSelectSearch != null) {
                jietiTypesSelectSearch.add(new Option('-请选择-',''));
                if (jietiTypesOptions != null && jietiTypesOptions.length > 0){
                    for (var i = 0; i < jietiTypesOptions.length; i++) {
                            jietiTypesSelectSearch.add(new Option(jietiTypesOptions[i].indexName,jietiTypesOptions[i].codeIndex));
                    }
                }
            }
        }
